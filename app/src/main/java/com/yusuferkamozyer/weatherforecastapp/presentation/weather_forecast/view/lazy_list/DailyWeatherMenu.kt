...
@Composable
fun DailyWeatherMenuList(
    dailyWeatherModelList: List<DailyWeatherModel>,
    ...
    Card(
        ...
        Column(
            ...
            Button(
                onClick = {
                    navController.navigate("${Screen.WeekWeatherForecastScreen.route}/$lat/$lon") },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(5.dp),
                shape = RoundedCornerShape(10.dp),
                colors = ButtonDefaults.buttonColors(
                    contentColor = AppColors.primaryContainerLightMediumContrast,
                    disabledContentColor = AppColors.primaryContainerLightMediumContrast,
                    disabledContainerColor = AppColors.primaryContainerLightMediumContrast,
                    containerColor = AppColors.primaryContainerLightMediumContrast
                )
            ) {
                Text(
...
fun DailyWeatherMenuItem(dailyWeatherModel: DailyWeatherModel) {
    Row {
        ...
        Spacer(Modifier.width(5.dp))
        Text(
            text = dailyWeatherModel.description,
            color = Color.White,
            fontSize = 11.sp,
            fontFamily = Constants.fontFamily,
            style = MaterialTheme.typography.headlineMedium
